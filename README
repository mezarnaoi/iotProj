...
### Sistem inteligent de detecție a accidentelor pentru cască moto
...
- Viteza în tab-ul Telemetrie afișează întotdeauna 0 km/h (datele de viteză de la GPS nu sunt implementate în firmware)
- Aplicația nu are notificări push când rulează în background
- Alertele SOS sunt trimise doar prin Discord webhook; nu există integrare SMS sau apel telefonic
...
*RideGuard Pro — Documentație Tehnică*# RideGuard Pro — Documentație Tehnică
### Sistem inteligent de detecție a accidentelor pentru cască moto
